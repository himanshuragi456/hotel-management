...
class SettingsController extends Controller
{
    ...
    private function tenantData(Tenant $tenant): array
    {
        return [
            ...
            'packing_charge_enabled'        => (bool) ($tenant->packing_charge_enabled ?? false),
            'packing_charge_on_aggregator'  => (bool) ($tenant->packing_charge_on_aggregator ?? false),
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        $request->validate([
            ...
            'packing_charge_enabled'        => 'sometimes|boolean',
            'packing_charge_on_aggregator'  => 'sometimes|boolean',
        ...
        $tenant->update($request->only([
            ...
            'packing_charge_enabled',
            'packing_charge_on_aggregator',
            'kot_enabled',
            'kot_auto_print',
            'kot_printer',
            'bill_auto_print',
