  ...
  return (
    <main className="pb-32">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <button
          onClick={() => router.back()}
          className="flex items-center gap-2 text-stone-500 hover:text-stone-800 text-sm transition-colors duration-150 cursor-pointer"
        >
          <ArrowLeft className="w-4 h-4" />
          Back
        </button>
              ...
              <div className="flex items-start justify-between gap-4 mb-3">
                <div>
                  ...
                  <p className="text-stone-500 text-sm mt-0.5">
                    {restaurant.cuisine_type ?? "Restaurant"} · {PRICE_LABELS[restaurant.price_range]}
                  </p>
                </div>
              ...
              <div className="flex flex-wrap gap-4 text-sm text-stone-500">
                ...
                {restaurant.phone && (
                  <a
                    ...
                    className="flex items-center gap-1.5 hover:text-rose-600 transition-colors duration-150"
                  >
      ...
      {selectedTable && (
        <div className="fixed bottom-6 left-0 right-0 z-40 flex justify-center px-4 pointer-events-none">
          <div className="pointer-events-auto flex items-center justify-between gap-6 bg-stone-900 text-white rounded-2xl px-5 py-4 shadow-2xl shadow-stone-900/30 w-full max-w-md">
            ...
            <Button size="sm" onClick={() => router.push(`/restaurants/${slug}/${selectedTable.id}`)} className="flex-shrink-0">
              View Menu
